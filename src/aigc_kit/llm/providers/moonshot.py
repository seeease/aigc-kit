...
环境变量:
    MOONSHOT_API_KEY: API 密钥（必需）
    MOONSHOT_MODEL: 模型名（默认 kimi-k2.5）
    MOONSHOT_BASE_URL: API 地址（默认 https://api.moonshot.cn/v1）
"""
...
class MoonshotProvider(LLMProvider):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_key = api_key or os.environ["MOONSHOT_API_KEY"]
        self._base_url = base_url or os.environ.get(
            "MOONSHOT_BASE_URL",
            "https://api.moonshot.cn/v1",
        )
        self._model = model or os.environ.get("MOONSHOT_MODEL", "kimi-k2.5")
    ...
    def chat(
        ...
        **kwargs: Any,
        ...
        return parse_response(response, provider="moonshot", model=use_model)
    ...
    def _build_kwargs(
        ...
        **extra: Any,
        ...
        # Moonshot temperature 范围 0.0-1.0，百分比映射
